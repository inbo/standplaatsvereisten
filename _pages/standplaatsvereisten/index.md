...
<div class="card-grid">
    ...
    <div class="card-image-wrapper">
      <img class="card-image" src="{{ '/assets/backgrounds/card_kusthabitats.jpg' | relative_url }}" alt="Zeekraal, Zwin">
  ...
  <div class="card">
  <div class="card-image-wrapper">
     <img class="card-image" src="{{ '/assets/backgrounds/card_duinen.jpg' | relative_url }}" alt="Gefixeerde duinen, De Panne">
     <span class="card-attribution">© Yves Adams</span>
    </div>
